    ...
    public function viewKaryawan()
    {
        ...
        return DataTable::of($query)
            ->add('action', function ($row) {
                $button1 = '<button type="button" class="btn btn-primary btn-sm btn-detail" data-idkaryawan="' . $row->idkaryawan . '" data-toggle="modal" data-target="#detailModal"><i class="ri-eye-line"></i></button>';
                $button2 = '<button type="button" class="btn btn-secondary btn-sm btn-edit" data-idkaryawan="' . $row->idkaryawan . '" style="margin-left: 5px;"><i class="ri-pencil-line"></i></button>';
                $button3 = '<button type="button" class="btn btn-danger btn-sm btn-delete" data-idkaryawan="' . $row->idkaryawan . '" style="margin-left: 5px;"><i class="ri-delete-bin-line"></i></button>';
