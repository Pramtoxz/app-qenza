...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-3 no-print">
    <h4 class="mb-0">Laporan Karyawan</h4>
    <div>
...
function loadData() {
    ...
    $.ajax({url: '<?= base_url('laporan-master/karyawan/view') ?>', dataType: 'json', success: function(r) {
        dataLoaded = r.data || '';
...
function cetakLaporan() {
    ...
    w.document.write('<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Laporan Karyawan</title>' +
        ...
        '</style></head><body>' +
        '<div class="header"><h2>PENCUCIAN QENZA</h2><p>Sungai Jodi, Kec. Lubuk Tarok, Kabupaten Sijunjung</p><hr><div class="title">Laporan Data Karyawan</div></div>' +
        dataLoaded +
