...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-3 no-print">
    <h4 class="mb-0">Laporan Paket Cucian</h4>
    <div>
...
function loadData() {
    ...
    $.ajax({url: '<?= base_url('laporan-master/paket/view') ?>', dataType: 'json', success: function(r) {
        dataLoaded = r.data || '';
...
function cetakLaporan() {
    ...
    w.document.write('<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Laporan Paket Cucian</title>' +
        ...
        '</style></head><body>' +
        '<div class="header"><h2>PENCUCIAN QENZA</h2><p>Sungai Jodi, Kec. Lubuk Tarok, Kabupaten Sijunjung</p><hr><div class="title">Laporan Data Paket Cucian</div></div>' +
        dataLoaded +
