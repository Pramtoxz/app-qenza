    ...
    <div class="col-md-8">
        <div class="card shadow-lg h-100">
            <div class="card-header bg-maroon text-white">
                <h5 class="mb-0"><i class="fas fa-user-circle me-2"></i> Detail Karyawan</h5>
            </div>
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-4 fw-bold">ID Karyawan</div>
                    <div class="col-md-8"><?= $karyawan['idkaryawan'] ?></div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-4 fw-bold">Nama Karyawan</div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8"><i class="fas fa-phone-alt me-1"></i> <?= $karyawan['nohp'] ?></div>
                </div>
            </div>
        </div>
    </div>
